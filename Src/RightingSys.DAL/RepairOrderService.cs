    ...
    public class RepairOrderService
    {
        ...
        public bool AddNew(IList<Models.ys_RepairOrder> listModel)
        {
         ...
         VALUES([Id]
               ...
               ,@CreateTime)";
                ...
                #region  sqlParam
                SqlParameter s1 = new SqlParameter("@Id", r.Id);
                SqlParameter s2 = new SqlParameter("@RepairNo", r.RepairNo);
                SqlParameter s3 = new SqlParameter("@AssetsId", r.AssetsId);
                SqlParameter s4 = new SqlParameter("@CompanyId", r.CompanyId);
                SqlParameter s5 = new SqlParameter("@CompanyName", r.CompanyName);
                SqlParameter s6 = new SqlParameter("@RepairUserId", r.RepairUserId);
                SqlParameter s7 = new SqlParameter("@RepairUserName", r.RepairUserName);
                SqlParameter s8 = new SqlParameter("@Repairday", r.Repairday);
                SqlParameter s9 = new SqlParameter("@OperatorId", r.OperatorId);
                SqlParameter s10 = new SqlParameter("@OperatorName", r.OperatorName);
                SqlParameter s11 = new SqlParameter("@RepairPrice", r.RepairPrice);
                SqlParameter s12 = new SqlParameter("@CreateTime", r.CreateTime);
                SqlParameter s13 = new SqlParameter("@IsRemoved", r.IsRemoved);
                SqlParameter s14 = new SqlParameter("@RepairReason", r.RepairReason);
                #endregion
                SqlParameter[] cmdPara = new SqlParameter[] { s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13 ,s14};
        ...
        public bool Modify(IList<Models.ys_RepairOrder> listModel)
        {
            ...
            foreach (Models.ys_RepairOrder r in listModel)
            {
                ...
                SqlParameter s12 = new SqlParameter("@CreateTime", r.CreateTime);
                SqlParameter s13 = new SqlParameter("@IsRemoved", r.IsRemoved);
                SqlParameter s14 = new SqlParameter("@Finishday", r.Finishday);
                SqlParameter s15 = new SqlParameter("@RepairPrice", r.FinishUserId);
                SqlParameter s16 = new SqlParameter("@FinishUserId", r.FinishUserName);
                SqlParameter s17 = new SqlParameter("@IsFinish", r.IsFinish);
                SqlParameter s19 = new SqlParameter("@RepairDescription", r.RepairDescription);
                SqlParameter s20 = new SqlParameter("@RepairReason", r.RepairReason);
                #endregion
        ...
        {
            string sqlText = "select *from ys_RepairOrder";
