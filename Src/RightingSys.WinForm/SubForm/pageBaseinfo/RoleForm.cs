...
namespace RightingSys.WinForm.SubForm.pageBaseinfo
{
    public partial class RoleForm : BaseForm
    {
        ...
        RightingSys.Models.ACL_Role model = new RightingSys.Models.ACL_Role();
        private Guid RoleId = Guid.Empty;
        private bool RightIsChange = false;
        private List<RightingSys.Models.ACL_Role> RoleList;
        private DataTable tbAllFunc;

        private List<RightingSys.Models.ACL_Department> DeptList = new List<RightingSys.Models.ACL_Department>();
