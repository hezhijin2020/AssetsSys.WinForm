...
namespace RightingSys.WinForm.SubForm.pageBaseinfo
{
    public partial class DepartmentForm : BaseForm
    {
        ...
        RightingSys.Models.ACL_Department model = new RightingSys.Models.ACL_Department();
        RightingSys.BLL.DepartmentManager deptMg = new RightingSys.BLL.DepartmentManager();
        private List<RightingSys.Models.ACL_Department> dtAll;
        ...
        {
            model = new RightingSys.Models.ACL_Department();
            txtID.Text ="新ID";
            txtName.Text = "";
