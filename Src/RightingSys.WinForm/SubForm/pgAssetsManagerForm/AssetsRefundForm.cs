...
{
    public partial class AssetsRefundForm : BaseForm
    {
        BLL.RefundOrderManager  manager = new BLL.RefundOrderManager();
        public AssetsRefundForm()
        {
            InitializeComponent();
            Query();
        }
        ...
        {
            AssetsRefundEditForm sub = new AssetsRefundEditForm();
        ...
        public override void Print()
        {
            if (gvData.FocusedRowHandle >= 0)
            {
                ...
                DevReport.rptRefundOrder rpt = new DevReport.rptRefundOrder(Id);
                rpt.ShowPreview();
            }
        }
