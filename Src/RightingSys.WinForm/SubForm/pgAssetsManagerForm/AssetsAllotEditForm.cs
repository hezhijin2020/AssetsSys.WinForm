...
{
    public partial class AssetsAllotEditForm : BaseForm
    {
        public AssetsAllotEditForm()
        {
            InitializeComponent();
            Initial();
        }
        ...
        Models.ys_AllotOrder model = new Models.ys_AllotOrder();
        ...
        private void Initial()
        {
            ...
            //资产信息的初始化
            AppPublic.Control.InitalControlHelper.Assets_GridLookUpEdit(cbAssets, new AssetsStatus[] { AssetsStatus.ZY,AssetsStatus.JY },false);
            assetsList = AppPublic.Control.InitalControlHelper.GetAssetListByStatus(new AssetsStatus[] { AssetsStatus.ZY,AssetsStatus.JY });
            //控件数据的绑定
