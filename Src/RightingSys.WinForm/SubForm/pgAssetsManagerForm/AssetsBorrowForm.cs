...
{
    public partial class AssetsBorrowForm : BaseForm
    {
        BLL.BorrowOrderManager  manager = new BLL.BorrowOrderManager();
        public AssetsBorrowForm()
        {
            InitializeComponent();
            Query();
        }
        ...
        {
            AssetsBorrowEditForm sub = new AssetsBorrowEditForm();
        ...
        public override void Print()
        {
            if (gvData.FocusedRowHandle >= 0)
            {
                ...
                DevReport.rptBorrowOrder rpt = new DevReport.rptBorrowOrder(Id);
                rpt.ShowPreview();
            }
        }
