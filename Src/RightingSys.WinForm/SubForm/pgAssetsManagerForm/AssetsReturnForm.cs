...
{
    public partial class AssetsReturnForm : BaseForm
    {
        BLL.ReturnOrderManager  manager = new BLL.ReturnOrderManager();
        public AssetsReturnForm()
        {
            InitializeComponent();
            Query();
        }
        ...
        {
            AssetsReturnEditForm sub = new AssetsReturnEditForm();
        ...
        public override void Print()
        {
            if (gvData.FocusedRowHandle >= 0)
            {
                ...
                DevReport.rptReturnOrder rpt = new DevReport.rptReturnOrder(Id);
                rpt.ShowPreview();
            }
        }
