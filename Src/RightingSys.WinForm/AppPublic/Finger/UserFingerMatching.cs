...
namespace RightingSys.WinForm.AppPublic.Finger
{
    public partial class UserFingerMatching : DevExpress.XtraEditors.XtraForm
    {
        ...
        List<RightingSys.Models.ACL_FingerPrint> AllFinger = new List<RightingSys.Models.ACL_FingerPrint>();
        RightingSys.BLL.FingerPrintManager fingerMg = new RightingSys.BLL.FingerPrintManager();
        RightingSys.Models.ACL_FingerPrint model = new RightingSys.Models.ACL_FingerPrint();
        public Guid FingerUserId { get; private set; }
